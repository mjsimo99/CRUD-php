...
if(isset($_POST['submit'])){
  ...
  $query = "INSERT INTO list(username,dateN,salary)VALUES('$username','$dateN','$salary')";
...
<div class="container">
  ...
  <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="was-validated" >
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="username" placeholder="Enter usernam" name="username" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
      <label for="dateN">date de naissence</label>
      <input type="text" class="form-control" id="dateN" placeholder="Enter date de naissence" name="dateN" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
      <label for="dateN">salary</label>
      <input type="text" class="form-control" id="dateN" placeholder="Enter salary" name="salary" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
